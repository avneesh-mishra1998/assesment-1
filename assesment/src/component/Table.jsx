...
function Table({modal1, setModal1}) {
  ...
  return (
    <div>
        ...
        <table className="w-full border-separate border-spacing-y-1">
          <thead>
            <tr className="bg-[#DBE6FF]">
              <th className="p-3 py-2 text-[14px] font-semibold w-[20%] min-w-[60px] text-left">
                ID
              </th>
      ...
      {modal1 && (
        <EmployeeModal successHandler={successHandler} setModal1={setModal1} />
      )}
